...
"}}}
" Bufferline
hi! BufferLineFill             ctermbg=none ctermfg=9
hi! BufferLineBackground       ctermbg=0 ctermfg=9
hi! BufferLineBufferVisible          ctermbg=0 ctermfg=9
hi! BufferLineBufferSelected          ctermbg=0 ctermfg=9
hi! BufferLineTab ctermbg=0 ctermfg=9
hi! BufferLineTabSelected ctermbg=0 ctermfg=9
hi! BufferLineTabClose ctermbg=0 ctermfg=9
hi! BufferLineIndicatorSelected ctermbg=0 ctermfg=9
hi! BufferLineSeparator ctermbg=0 ctermfg=9
hi! BufferLineSeperatorVisible ctermbg=0 ctermfg=9
hi! BufferLineSeperatorSelected ctermbg=0 ctermfg=9
hi! BufferLineModified ctermbg=0 ctermfg=9
hi! BufferLineModifiedVisible ctermbg=0 ctermfg=9
hi! BufferLineModifiedSelected ctermbg=0 ctermfg=9
hi! BufferLineCloseButton ctermbg=0 ctermfg=9
hi! BufferLineCloseButtonVisible ctermbg=0 ctermfg=9
hi! BufferLineCloseButtonSelected ctermbg=0 ctermfg=9
hi! BufferLineDevIconVimSelected ctermbg=0 ctermfg=3
